...
<head>
  ...
  <meta name="description" content="Fotografía profesional para diplomas y graduaciones. Registra tu logro con calidad y elegancia.">
...
<body>
  ...
  <main class="hero" id="inicio">
    ...
    <section class="hero-content">
      <div class="hero-left animate-slide-up">
        <h2>Registra la <br />conquista <br />que <span>marca <br />una vida.</span></h2>
        <div class="line"></div>
        <p>Fotografía profesional para diplomas escolares, graduaciones y momentos especiales. Imágenes elegantes, naturales y de alta calidad para inmortalizar cada logro.</p>
      ...
      <div class="hero-center animate-fade-in-slow">
        <img src="assets/imagem/raul.1.png" alt="Fotógrafo sosteniendo cámara" />
      </div>
    ...
    <div style="max-width: 900px; margin: 0 auto; text-align: center;">
      ...
      <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 40px;">
        <div class="reveal" style="flex: 1; min-width: 200px;">
          ...
          <h4 style="font-size: 18px; margin-bottom: 10px;">Agendamiento</h4>
          <p style="color: rgba(255,255,255,0.6); font-size: 14px;">Te pones en contacto vía WhatsApp o Chatbot y elegimos juntos la mejor fecha y lugar.</p>
        </div>
        <div class="reveal" style="flex: 1; min-width: 200px; transition-delay: 0.2s;">
          ...
          <p style="color: rgba(255,255,255,0.6); font-size: 14px;">Un día relajado de fotos. Llevamos la toga, el birrete y toda la iluminación profesional.</p>
        </div>
        <div class="reveal" style="flex: 1; min-width: 200px; transition-delay: 0.4s;">
          ...
          <p style="color: rgba(255,255,255,0.6); font-size: 14px;">Las fotos pasan por un tratamiento de color de alto nivel y se entregan en una galería digital privada.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="portfolio" id="portfolio">
    <div class="portfolio-text reveal">
      ...
      <a href="#" class="portfolio-btn"> Ver más fotos → </a>
    </div>
    <div class="portfolio-gallery">
      <div class="portfolio-card reveal"><img src="assets/imagem/formanda.png" alt="Graduada" /></div>
      <div class="portfolio-card reveal"><img src="assets/imagem/diploma.jpg" alt="Birrete y diploma" /></div>
      <div class="portfolio-card reveal"><img src="assets/imagem/criança.png" alt="Niño" /></div>
      <div class="portfolio-card reveal"><img src="assets/imagem/formando.png" alt="Graduado" /></div>
    </div>
  </section>

  <section class="about" id="sobre">
    <div class="about-image reveal">
      <img src="assets/imagem/predio.png" alt="Edificio clásico" />
    </div>
    <div class="about-text reveal">
      <h2>Sobre</h2>
      <div class="line"></div>
      <h3>Fotografiar es <br /> eternizar logros.</h3>
      <p>Con una mirada atenta y sensibilidad, registro más que imágenes: registro historias, dedicación y victorias. Mi compromiso es entregar fotos que transmiten orgullo y emoción en cada detalle.</p>
  ...
  <footer class="footer">
    ...
    <p>© <span id="year"></span> • Diplomas Raúl. Todos los derechos reservados.</p>
  ...
  <div id="chatbot-container" class="chatbot-container hidden">
    ...
    <div id="chatbot-messages" class="chatbot-messages">
      <div class="message bot">
        ¡Hola! Soy el asistente virtual del estudio Diplomas Raúl. ¿Cómo puedo ayudarte con tu sesión hoy?
      </div>
    </div>
